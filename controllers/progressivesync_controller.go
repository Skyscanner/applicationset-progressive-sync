...
// +kubebuilder:rbac:groups=deployment.skyscanner.net,resources=progressivesyncs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=deployment.skyscanner.net,resources=progressivesyncs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=deployment.skyscanner.net,resources=progressivesyncs/finalizers,verbs=update
